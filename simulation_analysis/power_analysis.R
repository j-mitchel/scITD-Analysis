...
# save results
# save.image(file='/home/jmitchel/data/sim_data/power_analysis_res.RData')
...
pdf(file = "/home/jmitchel/figures/for_paper/power_analysis_all.pdf", useDingbats = FALSE,
    width = 5.25, height = 3)
...
pdf(file = "/home/jmitchel/figures/for_paper/power_analysis_single.pdf", useDingbats = FALSE,
    width = 4, height = 3)
