...
r_seeds <- c(201,3320,4900,55433,71299)

# all_res <- get_performance_range(param_test='de_strength', param_range=c(.25,.5,1,1.5,2.5), n_iter=10, 
#                                  rand_seeds=r_seeds, n_ctypes=2, ctype_de_prob=.3, n_donors=50,
#                                  cells_per_don=50, n_genes=500, n_process=3,
#                                  de_strength=1, condition.prob=c(.25,.75),
#                                  similarity.scale=1.5)
# 
# saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_de_strength.rds')
...
saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_de_strength_2.rds')
