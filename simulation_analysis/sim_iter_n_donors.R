...
r_seeds <- c(715,11011,42983,95865,101221)

# all_res <- get_performance_range(param_test='n_donors', param_range=c(10,20,50,100,200), n_iter=10, 
#                                  rand_seeds=r_seeds, n_ctypes=2, ctype_de_prob=.3, n_donors=50,
#                                  cells_per_don=50, n_genes=500, n_process=3,
#                                  de_strength=1, condition.prob=c(.25,.75),
#                                  similarity.scale=1.5)
# 
# saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_n_donors.rds')
...
saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_n_donors_2.rds')
