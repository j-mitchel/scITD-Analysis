...
r_seeds <- c(75055,14928,47323,55865)

# all_res <- get_performance_range(param_test='n_process', param_range=c(2,3,4,5), n_iter=10, 
#                                  rand_seeds=r_seeds, n_ctypes=2, ctype_de_prob=.3, n_donors=50,
#                                  cells_per_don=50, n_genes=500, n_process=2,
#                                  de_strength=1, condition.prob=c(.25,.75),
#                                  similarity.scale=1.5)
# 
# saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_n_proc.rds')

# ## trying with increased de_strength of 1.5
# all_res <- get_performance_range(param_test='n_process', param_range=c(2,3,4,5), n_iter=10, 
#                                  rand_seeds=r_seeds, n_ctypes=2, ctype_de_prob=.3, n_donors=50,
#                                  cells_per_don=50, n_genes=500, n_process=2,
...
#                                  similarity.scale=1.5)
# 
# saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_n_proc_2.rds')

# ## trying with .1 pval cutoff in form_tensor() same rest of parameters
# all_res <- get_performance_range(param_test='n_process', param_range=c(2,3,4,5), n_iter=10,
#                                  rand_seeds=r_seeds, n_ctypes=2, ctype_de_prob=.3, n_donors=50,
#                                  cells_per_don=50, n_genes=500, n_process=2,
#                                  de_strength=1.5, condition.prob=c(.25,.75),
#                                  similarity.scale=1.5)
# 
# saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_n_proc_3.rds')
...
all_res <- get_performance_range(param_test='n_process', param_range=c(2,3,4,5), n_iter=10,
                                 ...
                                 cells_per_don=100, n_genes=500, n_process=2,
                                 de_strength=1.5, condition.prob=c(.25,.75),
                                 similarity.scale=1.5)

saveRDS(all_res,file='/home/jmitchel/data/sim_data/iter_n_proc_4.rds')
