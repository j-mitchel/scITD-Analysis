...
pdf(file = "/home/jmitchel/figures/for_paper/lupus_v2/lupus_f5_gsea_double2.pdf", useDingbats = FALSE,
    width = 20, height = 15)
cool <- plot_gsea_hmap_w_similarity_v2(pbmc_container,factor_select=5,direc='down',thresh=.05)
dev.off()

# make plot of just 3rd cluster
plot_gsea_sub_v2(pbmc_container,factor_select=5,direc='down',thresh=.05,clust_select=1)
